...
public class CleverBotQuery {
     ...
     * <p>
     * Conversation identifer is set empty, thus calling sendRequest immediately
     * after instantiation will create a new conversation
     * </p>
     *
    ...
    /**
     * Gets the response from a request. Must be used after
     ...
     *
     * <p>
     * CleverBot API queries provide a random number greater than zero and less than
     * one thousand.
     * </p>
     *
     ...
     * <p>
     * This is a unique string used to identify conversation context to the
     * CleverBot API servers. This string is updated after every
     * <code>sendRequest()</code> call.
     * </p>
     *
    ...
    /**
     * Sends request to CleverBot servers. API key and phrase should be set prior to
     * this call
     *
