...
/**
 * Manages reading packet sendInformation from the netty's channel.
 *
 * @author relex lawl
 */
...
public class Packet {
    ...
    /**
     * The buffer being used to read the packet sendInformation.
     */
     ...
     * @param buffer     The buffer used to receive sendInformation from the netty's
     *                   channel.
     */
    ...
    /**
     * Gets the buffer used to receive the packet sendInformation.
     *
