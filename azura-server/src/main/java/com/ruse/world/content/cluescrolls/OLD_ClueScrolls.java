...
public enum OLD_ClueScrolls {
    ...
    public static Item[] ultraRareRewards = {new Item(22041, 1), // Black h'ween
            ...
            new Item(1048, 1), new Item(1042, 1), new Item(1046, 1), new Item(1044, 1), new Item(1040, 1),
            new Item(1038, 1), // phats
    ...
    private OLD_ClueScrolls(int clueId, Position digTile, int npcId, String hint) {
        this.clueId = clueId;
        ...
        for (int i = 0; i < OLD_ClueScrolls.values().length; i++) {
            if (player.getInventory().contains(OLD_ClueScrolls.values()[i].getClueId())
                ...
                if ((player.getPointsHandler().getClueSteps() >= 3 && c == 1)
                    ...
                    int newClue = Misc.getRandom(OLD_ClueScrolls.values().length - 1);
                    player.getInventory().add(OLD_ClueScrolls.values()[newClue].getClueId(), 1);
                }
                return true;
            }
        }
