...
public class Nex implements CombatStrategy {
    ...
    public static void spawn() {
        ...
        NEX = new NPC(13447, new Position(2874, 5210));
        NEX.getMovementCoordinator().setCoordinator(new Coordinator(true, 3));

        FUMUS = new NPC(13451, new Position(2866, 5217));
        UMBRA = new NPC(13452, new Position(2882, 5218));
        CRUOR = new NPC(13453, new Position(2865, 5203));
        GLACIES = new NPC(13454, new Position(2879, 5202));
