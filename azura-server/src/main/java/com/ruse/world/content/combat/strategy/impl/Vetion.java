                ...
                public void execute() {
                    if (tick == 0) {
                        ...
                        for (Player t : list) {
                            if (t == null)
                                continue;
                            if (t.getPosition().equals(start) || t.getPosition().equals(second)
                                    || t.getPosition().equals(last)) {
                                new CombatHit(vetion.getCombatBuilder(),
                                        new CombatContainer(vetion, t, 3, CombatType.MAGIC, true)).handleAttack();
                            }
                        }
