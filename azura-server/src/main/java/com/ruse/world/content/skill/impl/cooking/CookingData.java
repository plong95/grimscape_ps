...
public enum CookingData {
    ...
    RABBIT(3226, 3228, 7222, 1, 30, 33, "rabbit"), BIRD(9978, 9980, 9982, 1, 30, 33, "bird"),
    CHICKEN(2138, 2140, 2144, 1, 30, 33, "chicken"), SHRIMP(317, 315, 7954, 1, 30, 33, "shrimp"),
    ANCHOVIES(321, 319, 323, 1, 30, 34, "anchovies"), TROUT(335, 333, 343, 15, 70, 50, "trout"),
    COD(341, 339, 343, 18, 75, 54, "cod"), MACKEREL(353, 355, 357, 10, 60, 22, "mackerel"),
    SALMON(331, 329, 343, 25, 90, 58, "salmon"), TUNA(359, 361, 367, 30, 100, 58, "tuna"),
    LOBSTER(377, 379, 381, 40, 120, 74, "lobster"), BASS(363, 365, 367, 40, 130, 75, "bass"),
    SWORDFISH(371, 373, 375, 45, 140, 86, "swordfish"), MONKFISH(7944, 7946, 7948, 62, 150, 91, "monkfish"),
    SHARK(383, 385, 387, 80, 210, 94, "shark"), SEA_TURTLE(395, 397, 399, 82, 212, 105, "sea turtle"),
    MANTA_RAY(389, 391, 393, 91, 217, 99, "manta ray"), ROCKTAIL(15270, 15272, 15274, 92, 225, 93, "rocktail"),

    FURY_SHARK(17815, 17817, 15274, 120, 325, 99, "fury shark"), HEIM_CRAB(17797, 18159, 18179, 5, 22, 40, "heim crab"),
    RED_EYE(17799, 18161, 18181, 10, 41, 45, "red-eye"), DUSK_EEL(17801, 18163, 18183, 12, 61, 47, "dusk eel"),
    ...
    SALVE_EEL(17811, 18173, 18193, 60, 168, 81, "salve eel"), BLUE_CRAB(17813, 18175, 18195, 75, 191, 92, "blue crab"),
    ;

    public static final int[] cookingRanges = {12269, 2732, 114, 2728};
