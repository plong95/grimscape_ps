...
public enum CombatSpecial {
    ...
    /*
     * private CombatSpecial(int[] identifiers, int drainAmount, double
     * strengthBonus, double accuracyBonus, CombatType combatType, WeaponInterface
     * weaponType) { this.identifiers = identifiers; this.drainAmount = drainAmount;
     * this.strengthBonus = strengthBonus; this.accuracyBonus = accuracyBonus;
    ...
    MINIGUN(new int[]{19135, 19136, 19137, 20173, 671, 20553, 19843, 18636, 8088, 8411, 5012, 5010, 5011, 22113, 21606, 8001, 22089, 9929, 14056, 15785, 8253, 22083}, 33, 1.01, 2.01, CombatType.RANGED,
