...
public class GrandExchange {
                    ...
                    case 24750:
                        if (player.getGrandExchangeSlots()[player.getSelectedGeSlot()].getOffer() == null
                            ...
                            if (offerType == OfferType.BUYING) {
                                ...
                                if (player.getInventory().getAmount(ItemDefinition.COIN_ID) < cost) {
                                    player.getPacketSender()
                                            .sendMessage("You do not have enough coins to make this purchase.");
                                    return true;
                                }
                                player.getInventory().delete(ItemDefinition.COIN_ID, cost);
        ...
        if (geSlot.getState() == GrandExchangeSlotState.PENDING_PURCHASE
            ...
            if (geSlot.getOffer().getAmountFinished() == 0) {
                if (geSlot.getOffer().getCoinsCollect() > 0) {
                    player.getPacketSender().sendItemOnInterface(53781, ItemDefinition.COIN_ID, geSlot.getOffer().getTotalCost());
                }
            } else {
                if (geSlot.getOffer().getItemCollect() > 0) {
                    ...
                    if (geSlot.getOffer().getCoinsCollect() > 0) {
                        player.getPacketSender().sendItemOnInterface(53782, ItemDefinition.COIN_ID, geSlot.getOffer().getCoinsCollect());
                    }
                } else {
                    if (geSlot.getOffer().getCoinsCollect() > 0) {
                        player.getPacketSender().sendItemOnInterface(53781, ItemDefinition.COIN_ID, geSlot.getOffer().getCoinsCollect());
                    }
                }
            }
        }
            ...
            if (offer.getAmountFinished() == 0) {
                ...
                if (offer.getItemCollect() > 0) {
                    ...
                    if (offer.getCoinsCollect() > 0) {
                        player.getPacketSender().sendItemOnInterface(54782, ItemDefinition.COIN_ID, offer.getCoinsCollect());
                    }
                } else {
                    if (offer.getCoinsCollect() > 0) {
                        player.getPacketSender().sendItemOnInterface(54781, ItemDefinition.COIN_ID, offer.getCoinsCollect());
                    }
                }
            }
        }
    ...
    public static void collectItem(Player player, int id, int itemBox, OfferType type) {
        ...
        if (offer.getAmountFinished() == 0) {
            if (itemBox == 0) {
                returnId = type == OfferType.BUYING ? ItemDefinition.COIN_ID : properId;
            }
        } else {
            if (offer.getItemCollect() > 0) {
                if (itemBox == 0) {
                ...
                if (itemBox == 1) {
                    returnId = ItemDefinition.COIN_ID;
                }
            } else {
                if (itemBox == 0) {
                    returnId = ItemDefinition.COIN_ID;
        ...
        switch (type) {
            ...
            case BUYING:
                ...
                if (offer.getAmountFinished() == 0) {
                    ...
                    player.getInventory().add(returnId, returnId == ItemDefinition.COIN_ID ? offer.getCoinsCollect() : offer.getItemCollect());
                } else {
                    player.getInventory().add(returnId, returnId == ItemDefinition.COIN_ID ? offer.getCoinsCollect() : offer.getItemCollect());
                }
                if (returnId == ItemDefinition.COIN_ID) {
                    offer.setCoinsCollect(0);
                } else {
                    offer.setItemCollect(0);
                }
