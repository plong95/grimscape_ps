...
public class Construction {
    ...
    public static void buyHouse(Player p) {
        ...
        if (p.getInventory().getAmount(ItemDefinition.COIN_ID) < 5000000) {
            p.getPacketSender().sendMessage("You do not have 5,000,000 coins.");
            return;
        }
        p.getInventory().delete(ItemDefinition.COIN_ID, 5000000).refreshItems();
        for (int x = 0; x < 13; x++)
            for (int y = 0; y < 13; y++)
        ...
        switch (buttonId) {
            ...
            case 2461:
                ...
                if (p.getDialogueActionId() == 457) {
                    ...
                    if (p.getInventory().getAmount(ItemDefinition.COIN_ID) >= b.getLoanCost()) {
                        p.setHouseServantCharges(8);
                        p.getInventory().delete(ItemDefinition.COIN_ID, b.getLoanCost());
                    } else {
    ...
    public static boolean roomExists(Player p) {
        ...
        if (room == null)
            return false;
        return room.getType() != ConstructionData.BUILDABLE && room.getType() != ConstructionData.EMPTY
    ...
    public static void createRoom(int roomType, Player p, int toHeight) {
        ...
        if (rd == null)
            return;
        if (p.getInventory().getAmount(ItemDefinition.COIN_ID) < rd.getCost()) {
