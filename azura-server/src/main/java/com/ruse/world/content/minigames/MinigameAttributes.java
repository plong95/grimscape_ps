...
public class MinigameAttributes {
    ...
    private final VoidOfDarknessAttributes voidOfDarknessAttributes = new VoidOfDarknessAttributes();
    ...
    public VoidOfDarknessAttributes getVoidOfDarknessAttributes() {
        return voidOfDarknessAttributes;
    }
    ...
    public class VoidOfDarknessAttributes {
        private int killcount;
        // TODO maybe use state 2 for killed and 1 for spawned?
