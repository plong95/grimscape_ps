...
public class CombatRangedAmmo {
    ...
    public enum RangedWeaponData {
        ...
        GODBOW(new int[]{19143, 19149, 19146},
                ...
                RangedWeaponType.SHORTBOW),
        ZARYTE_BOW(new int[]{20171, 23144}, new AmmunitionData[]{AmmunitionData.ZARYTE_AMMO}, RangedWeaponType.SHORTBOW),
        BSOAT(new int[]{6818},
                new AmmunitionData[]{AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW,
                        AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW,
                        AmmunitionData.RUNE_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW,
        ...
        public static RangedWeaponData getData(Player p) {
            ...
            if (weaponName.contains(" bow") || weaponName.contains(" crossbow")) {
                if (p.getWeapon().equals(WeaponInterfaces.WeaponInterface.CROSSBOW)) {
                    return RangedWeaponData.ARMADYL_CROSSBOW;
                }
                if (p.getWeapon().equals(WeaponInterfaces.WeaponInterface.LONGBOW)
                        || p.getWeapon().equals(WeaponInterfaces.WeaponInterface.SHORTBOW)) {
                    return RangedWeaponData.ZARYTE_BOW;
                }
            }
