...
public class OLDNewZulrah implements CombatStrategy {
    ...
    // private static ArrayList<TilePointer> poisonedTiles = new
    // ArrayList<TilePointer>();
     ...
     *
     * @param firstSpawn Determines whether this is the first time the method is
     *                   being called.
     */
    ...
    public static void move() {
        ...
        TaskManager.submit(new Task(4, ZULRAH, false) {
            ...
            public void execute() {
                ...
                // System.out.println("Zulrah: " + zulrahId + ", phase = " + phase + ", Moved to newpos: " + newpos
                //	+ ", x: " + moveX[newpos] + ", y: " + moveY[newpos]);
                isDiving = false;
    ...
    private static int getDir() {
        ...
        if (ZULRAH != null && ZULRAH.isRegistered() && ZULRAH.getPosition().getX() != moveX[dir]) {
            // System.out.println("Error. Dir = " + dir + ", Zulrah's pos = " + ZULRAH.getPosition().getX() + ", moveX["
            //	+ dir + "] = " + moveX[dir]);
        }
        return dir;
    }
    ...
    private static int newDir() {
        ...
        if (ZULRAH != null && ZULRAH.isRegistered() && ZULRAH.getPosition().getX() != moveX[current]) {
            // System.out.println("[ERROR 666] Zulrah's X = " + ZULRAH.getPosition().getX() + ", dir = " + current
