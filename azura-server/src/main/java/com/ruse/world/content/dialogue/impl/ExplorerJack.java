    ...
    public static Dialogue getDialogue(Player player) {
        return new Dialogue() {
            ...
            public String[] dialogue() {
                return new String[]{"Hello adventurer.", "I have travelled all around " + GameSettings.RSPS_NAME,
            ...
            public Dialogue nextDialogue() {
                return new Dialogue() {
                    ...
                    @Override
                    public String[] dialogue() {
                        return new String[]{"Hello adventurer.",
                                "I have traveled all around " + GameSettings.RSPS_NAME,
