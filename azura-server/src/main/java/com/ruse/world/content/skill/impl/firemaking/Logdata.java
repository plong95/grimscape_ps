...
public class Logdata {
    ...
    public static enum logData {
        ...
        LOG(1511, 1, 40, 30, 2732), LOG_RED(7404, 1, 50, 30, 11404), LOG_BLUE(7406, 1, 50, 30, 11406),
        LOG_GREEN(7405, 1, 50, 30, 11405), LOG_PURPLE(10329, 1, 50, 30, 20001), LOG_WHITE(10328, 1, 50, 30, 20000),
