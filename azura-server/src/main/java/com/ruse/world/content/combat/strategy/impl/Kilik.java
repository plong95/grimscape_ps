...
public class Kilik implements CombatStrategy {
    ...
    public boolean customContainerAttack(Character entity, Character victim) {
        ...
        if (random <= 8 && Locations.goodDistance(Kilik.getPosition().getX(), Kilik.getPosition().getY(),
        ...
        } else if (random <= 4 || !Locations.goodDistance(Kilik.getPosition().getX(), Kilik.getPosition().getY(),
