...
public enum JewelryTeleports {
    ...
    GLORY(new Position[]{new Position(3088, 3506, 0), new Position(2918, 3176, 0), new Position(3105, 3251, 0),
            new Position(3292, 3176, 0)}, new int[]{1712, 1710, 1708, 1706, 1704}, 88, 48),
    COMBAT(new Position[]{new Position(3088, 3506, 0), new Position(2918, 3176, 0), new Position(3105, 3251, 0),
            new Position(3292, 3176, 0)}, new int[]{11118, 11120, 11122, 11124, 11126}, 88, 48),
    DUELING(new Position[]{new Position(3370, 3269, 0), new Position(2441, 3090, 0)},
            new int[]{2552, 2554, 2556, 2558, 2560, 2562, 2564, 2566}, 196, 196),
    GAMES(new Position[]{new Position(2898, 3562, 0), new Position(2552, 3563, 0)},
            new int[]{3853, 3855, 3857, 3859, 3861, 3863, 3865, 3867}, 197, 197),
    DIGSITE(new Position[]{new Position(3351, 3346, 0)}, new int[]{11194, 11193, 11192, 11191, 11190}, 198, 198),
    ;
