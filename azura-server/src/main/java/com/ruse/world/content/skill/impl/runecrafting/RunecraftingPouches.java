...
public class RunecraftingPouches {
    ...
    public static void check(Player p, RunecraftingPouch pouch) {
        p.getPacketSender()
                .sendMessage("Your pouch currently contains " + p.getStoredPureEssence() + "/" + pouch.maxPureEss
                        + " Pure essence, and " + p.getStoredRuneEssence() + "/" + pouch.maxRuneEss + " Rune essence.");
    }
