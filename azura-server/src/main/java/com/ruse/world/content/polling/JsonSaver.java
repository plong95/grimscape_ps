 ...
 * </pre>
 *
 * @author Adam_#6723 <https://github.com/adamtrinity>
 */
public final class JsonSaver {
    ...
    /**
     * Creates a new {@link JsonSaver} that can have an infinite amount of tables.
     */
    public JsonSaver() {
        this(false);
    }
    ...
    /**
     * Adds the data within {@code currentWriter} to the internal {@link JsonArray}
    ...
    /**
     * Publishes the contents of this {@link JsonSaver} to the file at {@code path}.
     *
