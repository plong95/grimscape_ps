...
public class Brandon implements CombatStrategy {
    ...
    public boolean customContainerAttack(Character entity, Character victim) {
        ...
        if (random <= 8 && Locations.goodDistance(Brandon.getPosition().getX(), Brandon.getPosition().getY(),
        ...
        } else if (random <= 4 || !Locations.goodDistance(Brandon.getPosition().getX(), Brandon.getPosition().getY(),
