...
public class Crimson implements CombatStrategy {
    ...
    public boolean customContainerAttack(Character entity, Character victim) {
        ...
        if (random <= 8 && Locations.goodDistance(Crimson.getPosition().getX(), Crimson.getPosition().getY(),
        ...
        } else if (random <= 4 || !Locations.goodDistance(Crimson.getPosition().getX(), Crimson.getPosition().getY(),
                victim.getPosition().getX(), victim.getPosition().getY(), 8)) {
