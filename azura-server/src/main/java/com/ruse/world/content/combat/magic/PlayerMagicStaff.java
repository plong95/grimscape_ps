...
public enum PlayerMagicStaff {
    ...
    AIR(new int[]{1381, 1397, 1405}, new int[]{556}), WATER(new int[]{1383, 1395, 1403}, new int[]{555}),
    EARTH(new int[]{1385, 1399, 1407}, new int[]{557}), FIRE(new int[]{1387, 1393, 1401}, new int[]{554}),
    MUD(new int[]{6562, 6563}, new int[]{555, 557}), LAVA(new int[]{3053, 3054}, new int[]{554, 557}),
    OMNI(new int[]{13642, 15835, 17293},
            new int[]{554, 555, 556, 557, 558, 559, 560, 561, 562, 563, 564, 565, 566, 9075}),
    BLOOD_BURST(new int[]{13634}, new int[]{562, 560, 565}),
    ICE_BURST(new int[]{13632}, new int[]{562, 560, 555}), AHRIM(new int[]{4710}, new int[]{556}),
    BLASE_RUNES(new int[]{13641}, new int[]{556, 558, 555, 554, 557, 562, 560});

    public static int[] allstaves = {1381, 1397, 1405, 1383, 1395, 1403, 1385, 1399, 1407, 1387, 1393, 1401, 6562,
            6563, 3053, 3054, 554, 557, 13642, 15835, 17293, 13634, 13632, 13641};
    /**
    ...
    /**
     * Suppress items in the argued array if any of the items match the runes that
     * are represented by the staff the argued player is wielding.
     *
