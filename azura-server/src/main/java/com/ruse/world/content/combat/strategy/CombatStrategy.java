...
public interface CombatStrategy {
    ...
    /**
     * Determines if the attacking {@link Entity} is able to make an attack. Used
     * for miscellaneous checks such as runes, arrows, target, etc.
     *
     ...
     * @return the combat container that will be used to deal damage to the victim
     * during this hook.
     */
    ...
    default boolean ignoreAttackDistance() {
        return false;
    }
}
