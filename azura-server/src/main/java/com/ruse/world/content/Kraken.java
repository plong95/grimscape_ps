...
public class Kraken {
        ...
        if (d != null) {
            ...
            TaskManager.submit(new Task(1, player, false) {
                ...
                protected void execute() {
                    ...
                    Position positionToSpawn = kraken ? new Position(3677, 9887, player.getPosition().getZ())
                            : new Position(d.spawn.getX() + 2, d.spawn.getY() + 1, player.getPosition().getZ());
    ...
    private static enum WhirpoolData {
        ...
        SMALL_POOL_1(2895, new Position(3679, 9884)), SMALL_POOL_2(2900, new Position(3676, 9884)),
        SMALL_POOL_3(2902, new Position(3676, 9891)), SMALL_POOL_4(2903, new Position(3679, 9891)),
