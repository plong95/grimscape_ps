...
public enum CombatSpells {
    ...
    WIND_STRIKE(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 1005, 44, 3, 43, 31, 0));
        }
    ...
    GIANTSTAFF(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 2948, 44, 3, 43, 31, 0));
        }
    ...
    BEGINNER(new CombatNormalSpell() {
        @Override
        public int baseExperience() {
            return 0;
        }
