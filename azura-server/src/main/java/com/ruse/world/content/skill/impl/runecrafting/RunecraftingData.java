...
public class RunecraftingData {
    ...
    public enum TalismanData {
        ...
        AIR_TALISMAN(1438, 1, new Position(2841, 4828)), MIND_TALISMAN(1448, 2, new Position(2841, 4828)),
        ...
        ASTRAL_TALISMAN(-1, 40, null), NATURE_TALISMAN(1462, 44, new Position(2400, 4834)),
    ...
    public enum RuneData {
        AIR_RUNE(556, 1, 5, 2478, false), MIND_RUNE(558, 2, 6, 2479, false), WATER_RUNE(555, 5, 7, 2480, false),
        EARTH_RUNE(557, 9, 8, 2481, false), FIRE_RUNE(554, 14, 10, 2482, false), BODY_RUNE(559, 20, 11, 2483, false),
        COSMIC_RUNE(564, 27, 12, 2484, true), CHAOS_RUNE(562, 35, 13, 2487, true),
        ASTRAL_RUNE(9075, 40, 14, 17010, true), NATURE_RUNE(561, 44, 15, 2486, true), LAW_RUNE(563, 54, 16, 2485, true),
        DEATH_RUNE(560, 65, 17, 2488, true), BLOOD_RUNE(565, 75, 24, 30624, true),
