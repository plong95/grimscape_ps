...
public class ItemsKeptOnDeath {
    ...
    public static void sendInterfaceData(Player player) {
        ...
        switch (size) {
            case 0: // Player must be skulled WITHOUT the protect item prayer/curse active, player
                // will keep 0 items.
                infoToFill[0] = "You are skulled and will";
                infoToFill[1] = "not keep any items on";
                infoToFill[2] = "death.";
                break;
            case 1: // Player must be skulled but have the protect item prayer/curse active, player
                // will keep 1 item.
            case 4: // Player is not skulled & has protect item prayer/curse active, player will
                // keep 4 items. Send this info.
            ...
            case 2: // No such case where a player can keep 2 items.
                break;
            case 3: // Player has no factors active, size of array is 3 and player will keep 3
                // items.
