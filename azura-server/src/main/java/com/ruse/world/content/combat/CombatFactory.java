...
public final class CombatFactory {
    ...
    public static boolean npcsDeathDartDontWork(NPC npc) {
        int id = npc.getId();
        return id == 8013 || id == 8009 || id == 3830 || id == 187 || id == 3779 || id == 12239 || id == 7553 || id == 3305 || id == 9017 || id == 9014 || id == 9020;
    ...
    public static int calculateMaxMeleeHit(Character entity, Character victim) {
		...
		/*if (player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 9363
				&& player.getEquipment().getItems()[Equipment.BODY_SLOT].getId() == 9361
				&& player.getEquipment().getItems()[Equipment.LEG_SLOT].getId() == 9362) {
			voidDmgBonus = 6.9;
			maxHit *= 2.1;
        ...
        if (EquipmentBonus.voidmMelee(player)) {
            voidDmgBonus = 4.2;
            otherBonusMultiplier = 2.8;
        ...
        if (victim.isNpc()) {
            ...
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 18636) {
                maxHit *= 2.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 8088) {
                maxHit *= 3.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 5073) {
                maxHit *= 3.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 8411) {
                maxHit *= 6.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 5012) {
                maxHit *= 7.5;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 5011) {
                maxHit *= 8.8;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 22113) {
                maxHit *= 11;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 5010) {
                maxHit *= 8.8;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 8001) {
                maxHit *= 5.8;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 21606) {
                maxHit *= 4.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 15785) {
                maxHit *= 1.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 14919) {
                maxHit *= 1.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 8253) {
                maxHit *= 2.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 22089) {
                maxHit *= 2.2;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 7543) {
                maxHit *= 2.1;
            }
            if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 9929) {
                maxHit *= 2.2;
            }
    ...
    public static int calculateMaxRangedHit(Character entity, Character victim) {
        ...
        if (player.checkItem(Equipment.WEAPON_SLOT, 16879)) {
            maxHit *= 1.01;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 18332)) {
            maxHit *= 1.50;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 22083)) {
            maxHit *= 7.95;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 3738)) {
            maxHit *= 7.95;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 19843)) {
            maxHit *= 8.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 9941)) {
            maxHit *= 12.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 18636)) {
            maxHit *= 8.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 8088)) {
            maxHit *= 9.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 5073)) {
            maxHit *= 6.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 8411)) {
            maxHit *= 12.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 5012)) {
            maxHit *= 14.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 5011)) {
            maxHit *= 16.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 22113)) {
            maxHit *= 20.0625;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 5010)) {
            maxHit *= 16.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 8001)) {
            maxHit *= 11.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 21606)) {
            maxHit *= 9.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 15785)) {
            maxHit *= 1.15;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 8253)) {
            maxHit *= 8.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 22089)) {
            maxHit *= 8.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 7543)) {
            maxHit *= 2.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 9929)) {
            maxHit *= 8.05;
        }
        if (player.checkItem(Equipment.WEAPON_SLOT, 14056)) {
            maxHit *= 8.05;
        }
        ...
        if (victim != null && victim.isNpc()) {
            ...
            if (npc.getId() == player.getSlayer().getSlayerTask().getNpcId()) {
                if (player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 15492
                        || player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 15490) {
                    maxHit *= 1.13;
                }
            }
        }
                ...
                for (NpcRequirements req : NpcRequirements.values()) {
                    if (npc.getId() == req.getNpcId()) {
                        if (req.getKillCount() > 0) {
                            if (((Player) entity).getPointsHandler().getNPCKILLCount() < req.getKillCount()) {
                                return false;
                            }
                        } else {
