...
public class Region {
     ...
     * @param dataType the data type which this region uses.
     */
     ...
     *
     * @param object the object to pack it's properties.
     ...
     * Converts the specified object properties into a 32-bit packed integer.
     *
     * @param level the level of the local-space of the object.
     * @param x     the x of the local-space of the object.
     * @param y     the y of the local-space of the object.
     ...
     *
     * @param object the object to add to the region.
     */
     ...
     * Removes a currently visible object from the region and update all the visible players.
     *
     * @param level  the height level of the object to remove.
     * @param localX the local x position of the object to remove [0-63].
     * @param localY the local y position of the object to remove [0-63].
     * @param type   the type of the object to remove [0-3].
     */
     ...
     * {@code type}.
     *
     * @param level  the height level which the object is located at.
     * @param localX the local x position which the object is located at.
     * @param localY the local y position which the object is located at.
     * @param type   the type of the object.
     ...
     * @param level    the level of the local-coordinate of the object.
     * @param x        the x of the local-coordinate of the object.
     * @param y        the y of the local-coordinate of the object.
     ...
     *
     * @param object the original object to add to the region.
     */
     ...
     * @param type     the type of of the object.
     ...
     * Returns the original {@link GameObject} at the specified local-space coordinate.
     *
     * @param level the level of the local-space coordinate.
     * @param x     the x of the local-space coordinate.
     * @param y     the y of the local-space coordinate.
     * @param type  the type of of the object.
     * @return the {@link GameObject} object if it was present otherwise {@code null}.
     */
     ...
     * @param x       the x of the local-space coordinate.
     * @param y       the y of the local-space coordinate.
     * @param objects the objects to set at the coordinate
     */
     ...
     *
     * @param level  the level of the local-space coordinate.
     * @param localX the x-position in the local-space coordinate.
     * @param localY the y-position in the local space coordinate.
     ...
     *
     * @param action   the action to apply for each of the visible players.
     * @param position the position to check if the player is visible from or {@code null} if there should be no check.
     */
