...
public interface UpdateSequence<T extends Character> {
    ...
    /**
     * The main stage of the update sequence that performs parallelized updating on
     * the entity.
     *
    ...
    /**
     * The last stage of the update sequence that resets the entity and prepares it
     * for the next cycle.
     *
