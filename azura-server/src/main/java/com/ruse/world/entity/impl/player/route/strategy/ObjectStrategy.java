...
public class ObjectStrategy extends RouteStrategy {
    ...
    public ObjectStrategy(GameObject object) {
        ...
        this.rotation = object.getFace();
        this.sizeX = rotation == 0 || rotation == 2 ? object.getDefinition().tileSizeX : object.getDefinition().tileSizeY;
        this.sizeY = rotation == 0 || rotation == 2 ? object.getDefinition().tileSizeY : object.getDefinition().tileSizeX;
        if (rotation != 0)
