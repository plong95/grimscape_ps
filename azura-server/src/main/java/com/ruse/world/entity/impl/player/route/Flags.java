...
public final class Flags {
    ...
    public static final int FLOOR_BLOCKANY = FLOOR_BLOCKSWALK | FLOORDECO_BLOCKSWALK | OBJ;
    public static final int WALL_BLOCKANY = CORNEROBJ_NORTHEAST | CORNEROBJ_NORTHWEST | CORNEROBJ_SOUTHEAST | CORNEROBJ_SOUTHWEST | WALLOBJ_EAST | WALLOBJ_NORTH | WALLOBJ_SOUTH | WALLOBJ_WEST;
}
