...
public class EnterSyntaxToSearchDropsFor extends Input {
    ...
    public void handleSyntax(Player player, String syntax) {
         ...
         * player.getPacketSender().sendMessage("Your drop interface = "+player.
         * getInterfaceId()); player.getPacketSender().
         * sendMessage("You can only search with the drop interface open."); return; }
         */
