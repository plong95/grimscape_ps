...
public final class WeaponInterfaces {
    ...
    public static void init() {
        int count = ItemDefinition.getMaxAmountOfItems();
        for (int id = 0; id < count; id++) {
            ItemDefinition definition = ItemDefinition.forId(id);
            if (definition == null) {
                continue;
            }
            String lowerName = definition.getName();
            if (lowerName == null) {
                continue;
            }
            ...
            } else if (lowerName.contains("flail")) {
                weaponInterface = WeaponInterface.MACE;
            } else if (lowerName.contains("polearm")) {
                weaponInterface = WeaponInterface.SPEAR;
            } else if (lowerName.contains("zamorakian spear")) {
                weaponInterface = WeaponInterface.SPEAR;
            } else if (lowerName.contains("spear")) {
                weaponInterface = WeaponInterface.SPEAR;
            } else if (lowerName.contains("dagger") && !lowerName.contains("abyssal")) {
                weaponInterface = WeaponInterface.DAGGER;
            } else if (lowerName.contains("scimitar")) {
                weaponInterface = WeaponInterface.SCIMITAR;
            } else if (lowerName.contains("longsword")) {
                weaponInterface = WeaponInterface.LONGSWORD;
            } else if (lowerName.contains("mace")) {
                weaponInterface = WeaponInterface.MACE;
            } else if (lowerName.contains("crossbow") || lowerName.contains("ballista")) {
                weaponInterface = WeaponInterface.CROSSBOW;
            } else if (lowerName.contains("hammers")) {
                weaponInterface = WeaponInterface.WARHAMMER;
            } else if (lowerName.contains("shortbow")) {
                weaponInterface = WeaponInterface.SHORTBOW;
            } else if (lowerName.contains("longbow") || lowerName.contains(" bow")) {
                weaponInterface = WeaponInterface.LONGBOW;
            } else if (lowerName.contains("chinchompa")) {
                weaponInterface = WeaponInterface.DART;
            } else if (lowerName.contains("dart")) {
                weaponInterface = WeaponInterface.DART;
            } else if (lowerName.contains(" sword") && !definition.isTwoHanded()) {
                weaponInterface = WeaponInterface.SWORD;
            } else if (lowerName.contains(" thrownaxe") || lowerName.contains("throwing axe")) {
                weaponInterface = WeaponInterface.THROWNAXE;
            } else if (lowerName.contains("whip") || lowerName.contains("abyssal tentacle")) {
                weaponInterface = WeaponInterface.WHIP;
            } else if (lowerName.contains(" wand")) {
                weaponInterface = WeaponInterface.STAFF;
            } else if (lowerName.contains(" harpoon")) {
                weaponInterface = WeaponInterface.LONGSWORD;
            } else if (lowerName.contains(" bulwark")) {
                weaponInterface = WeaponInterface.WARHAMMER;
            } else if (lowerName.contains(" sword") && definition.isTwoHanded()) {
                weaponInterface = WeaponInterface.TWO_HANDED_SWORD;
            } else if (lowerName.contains("axe") || lowerName.contains("hatchet")) {
                weaponInterface = WeaponInterface.BATTLEAXE;
            } else if (lowerName.contains("maul") || lowerName.contains("warhammer") || lowerName.contains("bludgeon")) {
                weaponInterface = WeaponInterface.WARHAMMER;
            ...
            interfaces.put(id, weaponInterface);
        }
    }
