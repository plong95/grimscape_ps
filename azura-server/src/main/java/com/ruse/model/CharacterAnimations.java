...
public class CharacterAnimations {
     ...
     */
    public CharacterAnimations(int standingAnimation, int walkingAnimation, int runningAnimation, int turnIndex,
                               int turn180Index, int turn90CWIndex, int turn90CCWIndex) {
    ...
    public String toString() {
        return "CHARACTER ANIMATIONS[standing= " + standingAnimation + ", walking= " + walkingAnimation + ", running= "
                + runningAnimation + ", turn = " + turnIndex + "]";
    }
