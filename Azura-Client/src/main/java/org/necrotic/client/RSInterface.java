...
public class RSInterface {
	...
	public void addStreamBoss(TextDrawingArea[] tda) {
		...
		RSInterface.addText(interfaceId + index++, "Solak's Event Boss", tda, 3, 16777215, true);
...
//these were diff btw not both supposed to be 1405 i guess
	...
	public static void goodiebagInterface(TextDrawingArea[] tda) { // open urcache,.
		...
		addText(STARTING_POINT + 2, "Solak's Goodiebag", tda, 2, ColorConstants.ORANGE, false, true);
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addText(52752, "Solak game mode selection screen", ColorConstants.ORANGE, true, true, 52, tda, 2);
		...
		addText(52764, "Play Solak as an Iron man.", ColorConstants.ORANGE2, true, true, 52, tda, 0);
	...
	public static void BoxRewardList(TextDrawingArea[] textDrawingAreas) {
		...
		RSInterface.addText(17552, "Solak Rewards List", textDrawingAreas, 2, 0xEAC117, true);
...
//        addHoveredImageWSpriteLoader(id + 400, 1050, 124, 34, id + 401);
		...
		addText(id, "Welcome to Solak", fonts, 2, 0xFF981F, true, true);
