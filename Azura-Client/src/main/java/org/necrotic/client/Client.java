...
public class Client extends GameRenderer {
    ...
    public static int viewDistance = (int) (Math.log(clientWidth) / Math.log(5));
    ...
    private static final Sound[] aClass26Array1468 = new Sound[50];
    ...
    private static final String[] skillNames = {"Attack", "Constitution", "Mining", "Strength", "Agility", "Smithing", "Defence", "Herblore", "Fishing", "Range", "Thieving", "Cooking", "Prayer", "Crafting", "Firemaking", "Magic", "Fletching", "Woodcutting", "Runecrafting", "Slayer", "Farming", "Invention", "Hunter", "Summoning"};
    ...
    private final int[] cameraAntibanCurveYOffsets;
   ...
   // private final java.util.List<Particle> deadParticles;
    ...
    private final int[] sapCurse = {1, 2, 3, 4, 19};
    private final int[] leechCurse = {10, 11, 12, 13, 14, 15, 16, 19};
    private final int[] deflectCurse = {7, 8, 9, 17, 18};
    private final CasketOpening casketOpening;
    ...
    public static void main(String[] args) throws InvocationTargetException, InterruptedException {
        SwingUtilities.invokeAndWait(() -> {
            try {
                if (Configuration.USING_INTELLIJ) {
    ...
    public static void loadGoals(String name) {
        try {
            File file = new File(Signlink.getCacheDirectory() + "/" + name.trim().toLowerCase() + ".goals");
            if (!file.exists()) {
    ...
    public void updateSettingsInterface() {
        ...
        updateSetting(26067, Configuration.FOG_ENABLED);
        updateSetting(26031, Configuration.GROUND_TEXT);
        updateSetting(26069, Configuration.PARTICLES_ENABLED);
  ...
  /*  public final void addParticle(Particle p) {
    ...
    private void buildAtNPCMenu(MobDefinition entityDef, int index, int y, int x) {
        ...
        if (spellSelected == 1) {
            ...
            if (entityDef.id == 3062 || entityDef.id == 770 || entityDef.id == 771 || entityDef.id == 769 || entityDef.id == 6960 || entityDef.id == 6958 || entityDef.id == 6968 || entityDef.id == 6964 || entityDef.id == 350 || entityDef.id == 351 || entityDef.id == 352 || entityDef.id == 928 || entityDef.id == 4000 || entityDef.id == 4001 || entityDef.id == 271 || entityDef.id == 133 || entityDef.id == 105 || entityDef.id == 4414 || entityDef.id == 189 || entityDef.id == 4444 || entityDef.id == 1902 || entityDef.id == 8802 || entityDef.id == 3309 || entityDef.id == 1898 || entityDef.id == 302 || entityDef.id == 1890 || entityDef.id == 1894 || entityDef.id == 1893 || entityDef.id == 1892 || entityDef.id == 1904 || entityDef.id == 3001 || entityDef.id == 5001 || entityDef.id == 3377 || entityDef.id == 4969 || entityDef.id == 6913 || entityDef.id == 6919 || entityDef.id == 6942 || entityDef.id == 6945 || entityDef.id == 3033 || entityDef.id == 3030 || entityDef.id == 3031 || entityDef.id == 3032 || entityDef.id == 3034 || entityDef.id == 3035 || entityDef.id == 3036 || entityDef.id == 3037 || entityDef.id == 3038 || entityDef.id == 3039 || entityDef.id == 3040 || entityDef.id == 3047 || entityDef.id == 3048 || entityDef.id == 3050 || entityDef.id == 3051 || entityDef.id == 3052 || entityDef.id == 3053 || entityDef.id == 3054 || entityDef.id == 3055 || entityDef.id == 3056 || entityDef.id == 3057 || entityDef.id == 3058 || entityDef.id == 3059 || entityDef.id == 3060 || entityDef.id == 3061 || entityDef.id == 6302 || entityDef.id == 6303 || entityDef.id == 6304 || entityDef.id == 6305 || entityDef.id == 6306 || entityDef.id == 6307 || entityDef.id == 6308 || entityDef.id == 6309 || entityDef.id == 6310 || entityDef.id == 6312 || entityDef.id == 6313 || entityDef.id == 6314 || entityDef.id == 6315 || entityDef.id == 6316 || entityDef.id == 6317 || entityDef.id == 6318 || entityDef.id == 6319 || entityDef.id == 6320 || entityDef.id == 6311 || entityDef.id == 6322 || entityDef.id == 6323 || entityDef.id == 6324 || entityDef.id == 3062 || entityDef.id == 1906 || entityDef.id == 184 || entityDef.id == 6431 || entityDef.id == 1801 // null
    ...
    private void buildInterfaceMenu(int xPadding, RSInterface rsInterface, int xPos, int yPadding, int yPos, int scrollPoint) {
        ...
        for (int index = 0; index < totalChildren; index++) {
            ...
            if ((child.hoverType >= 0 || child.disabledMouseOverColor != 0) && xPos >= xSpritePos && yPos >= ySpritePos && xPos < xSpritePos + child.width && yPos < ySpritePos + child.height) {
            ...
            if ((child.type == 8 || child.type == 10) && xPos >= xSpritePos && yPos >= ySpritePos && xPos < xSpritePos + child.width && yPos < ySpritePos + child.height) {
                anInt1315 = child.id;
            ...
            if (child.type == 0) {
                ...
                if (child.sideScroll) {
                    if (child.scrollMax > child.width) {
                        scrollInterfaceBottom(xSpritePos, child.width, xPos, yPos, child, ySpritePos + child.height, true, child.scrollMax);
                    }
                } else {
                    if (child.scrollMax > child.height) {
                        scrollInterface(xSpritePos + child.width, child.height, xPos, yPos, child, ySpritePos, true, child.scrollMax);
                    }
                }
            } else {
                ...
                if (child.hoverable && xPos >= xSpritePos && yPos >= ySpritePos && xPos < xSpritePos + child.width && yPos < ySpritePos + child.height) {
                    child.selected = true;
                ...
                if (child.atActionType == 1 && xPos >= xSpritePos && yPos >= ySpritePos && xPos < xSpritePos + child.width && yPos < ySpritePos + child.height) {
    ...
    private void calcEntityScreenPos(int i, int j, int l) {
        ...
        if (l >= 50) {
            ...
            spriteDrawY = Rasterizer.centerY + (i1 << viewDistance) / l;
        } else {
            spriteDrawX = -1;
            spriteDrawY = -1;
        }
    ...
    public void hitmarkDrawNew(Entity e, int hitLength, int type, int icon, int damage, int soak, int move, int opacity, int mask) {
        if (spriteDrawX > -1) {
            int drawPos = 0;
            if (mask == 0) {
            ...
            if (damage > 0) {
                ...
                end1 = spritesMap.get(792 + (type * 3));
                middle = spritesMap.get(792 + (type * 3) + 1);
                end2 = spritesMap.get(792 + (type * 3) + 2);
                if (icon != 255 && icon != 8) {
                    spritesMap.get(786 + icon).drawSprite3(spriteDrawX - 31 + x, drawPos - 9, opacity);
                }
    ...
    private void drawAnimatedWorldBackground(boolean display) {
        if (display) {
            ...
            if (loadingStage == 2 && ObjectManager.currentPlane != plane) {
                loadingStage = 1;
            }
    ...
    private void drawHeadIcon() {
        ...
        calcEntityScreenPos((anInt934 - regionBaseX << 7) + anInt937, anInt936 * 2, (anInt935 - regionBaseY << 7) + anInt938);
    ...
    private void drawModIcon(Player player) {
        ...
        int inty = 200;
        int sprite = 829;
        Client.spritesMap.get(sprite).drawSprite(intx, inty); // (spriteDrawX - 12, spriteDrawY - 28);
        System.out.println("We drew spritesMap.get(" + sprite + "] at : (" + intx + ", " + inty + ") (x,y)");
    ...
    private void drawProgressBar(int xPos, int yPos, int width, int height, int currentPercent, int firstColor, int secondColor, int strokeWidth) {
        ...
        DrawingArea.drawAlphaFilledPixels(xPos, yPos, (int) (width * (currentPercent / 100.0f)), height, secondColor, 255);
            ...
            if (childInterface.type == 0) {
                ...
                if (childInterface.sideScroll) {
                    if (childInterface.scrollMax > childInterface.width) {
                        drawScrollbarBottom(childInterface.width, childInterface.scrollPosition, childY + childInterface.height, childX, childInterface.scrollMax, false, false);
                    }
                } else {
                ...
                if (childInterface.type == 2) {
                                ...
                                if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32 && j6 < DrawingArea.clipBottom || activeInterfaceType != 0 && selectedInventorySlot == i3) {
                                    ...
                                    if (selectedItem != null) {
                                        if (activeInterfaceType != 0 && selectedInventorySlot == i3 && modifiedWidgetId == childInterface.id) {
                                            ...
                                            if (j6 + j7 + 32 > DrawingArea.clipBottom && class9.scrollPosition < class9.scrollMax - class9.height) {
                                                int j10 = anInt945 * (j6 + j7 + 32 - DrawingArea.clipBottom) / 3;
                    ...
                    if (anInt1039 == childInterface.id || anInt1048 == childInterface.id || anInt1026 == childInterface.id || childInterface == childHovered) {
                        flag = true;
                    }
                    ...
                    boolean flag1 = false;
                    if (anInt1039 == childInterface.id || anInt1048 == childInterface.id || anInt1026 == childInterface.id || childHovered == childInterface) {
                        flag1 = true;
                    }
                    int i4;
                    if (interfaceIsSelected(childInterface)) {
                    ...
                    if (childInterface.centerText) {
                        childInterface.textDrawingAreas.drawCenteredText(childInterface.enabledColor, childX + childInterface.messageOffsetX, childInterface.message, childY + childInterface.messageOffsetY, true);
                    } else {
                ...
                if (childInterface.type == 5) {
                    ...
                    if (childInterface.itemSpriteId > 0 && childInterface.disabledSprite == null && childInterface.enabledSprite == null) {
                        childInterface.disabledSprite = ItemDefinition.getSprite(childInterface.itemSpriteId, 1, (childInterface.itemSpriteZoom == -1) ? 0 : -1, childInterface.itemSpriteZoom, false);
                        childInterface.enabledSprite = ItemDefinition.getSprite(childInterface.itemSpriteId, 1, (childInterface.itemSpriteZoom == -1) ? 0 : -1, childInterface.itemSpriteZoom, false);
                    ...
                    if (childInterface.summonReq > 0 && childInterface.disabledSprite != null && childInterface.enabledSprite != null) {
                    ...
                    if (autoCast && childInterface.id == autocastId) {
                        spritesMap.get(497).drawSprite(childX - 3, childY - 3);//autocast enabled box
                    }
                } else if (childInterface.type == 553) {//hitsplat melee
                    Sprite sprite = null;
                    sprite = childInterface.disabledSprite;
                    ...
                    if (childInterface.widgetActive) {
                        ...
                        {
                            childInterface.textDrawingAreas.drawCenteredText(childInterface.disabledColor, childX + childInterface.messageOffsetX, childInterface.message, childY + childInterface.messageOffsetY, true);
                        } else {
                            childInterface.textDrawingAreas.drawText(childInterface.disabledColor, childInterface.message, childX + 5 + childInterface.messageOffsetX, childY + childInterface.messageOffsetY);
                        }
                    }
                    ...
                    for (int j5 = 0; j5 < childInterface.height; j5++) {
                        for (int i6 = 0; i6 < childInterface.width; i6++) {
                            if (childInterface.inv[k4] > 0) {
                                ...
                                if (childInterface.centerText) {
                                    textDrawingArea_1.drawCenteredText(childInterface.disabledColor, i9 + childInterface.width / 2, s2, k9, childInterface.textShadow);
                                } else {
                                    textDrawingArea_1.drawRegularText(childInterface.textShadow, i9, childInterface.disabledColor, s2, k9);
                                }
                            }
                            k4++;
                        }
    ...
    public void displayLoadingScreen() {
      /*  if (loadingImages[0] == null || loadingImages[1] == null || loadingImages[2] == null || loadingImages[3] == null) {
        ...
        if (loadingPercentage > 0) {
            ...
            graphics.drawImage(loadingImages[3], 72 + scaleX + addedX, 410 - 130, null);
    ...
    public void handleHovers(boolean alertScreen) {
        ...
        if (!alertScreen) {
            ...
            if (mouseX >= 280 && mouseX <= 485 && mouseY >= 312 && mouseY <= 350) {
                //cursor = Configuration.NEW_CURSORS ? 1061 : Cursor.HAND_CURSOR;
                loginHover = true;
            }

            if (showTwoFactorAuth) {
                if (mouseX >= 228 && mouseX <= 265 && mouseY >= 190 && mouseY <= 210) {
                    //cursor = Configuration.NEW_CURSORS ? 1061 : Cursor.HAND_CURSOR;
                    otherHover = true;
                }
                if (mouseX >= 236 && mouseX <= 536) {
                    if (mouseY >= 270 && mouseY <= 308) {
                        cursor = Cursor.TEXT_CURSOR;
                        textArea1Hover = true;
                    }
                }
            } else {
                if (mouseX >= 233 && mouseX <= 533) {
                    if (mouseY >= 189 && mouseY <= 229) {
                        cursor = Cursor.TEXT_CURSOR;
                        textArea1Hover = true;
                    } else if (mouseY >= 238 && mouseY <= 276) {
                        cursor = Cursor.TEXT_CURSOR;
                        textArea2Hover = true;
                    }
                }
        ...
        if (Configuration.DISPLAY_GAMEWORLD_ON_LOGIN) {
            ...
            if (titleAlpha < 250) {
                ...
                if (showTwoFactorAuth) {
                    ...
                    if (textArea1Hover) {
                        spritesMap.get(470).drawAdvancedSprite(237, 270);
                    } else {
                        spritesMap.get(469).drawAdvancedSprite(237, 270);
                    }
             ...
             /*   } else {
                    handleHovers(true);
                    spritesMap.get(1183].drawAdvancedSprite(0, 0);
                    spritesMap.get(1181].drawAdvancedSprite(215, 150);
...
*/
                ...
                if (!showTwoFactorAuth) {
                    for (int i = 0; i < loginMessages.length; i++) {
                        ...
                        int y = clientHeight / 2 + i * 20 + 240;
                        chatTextDrawingArea.drawRegularText(true, clientWidth / 2 - chatTextDrawingArea.getTextWidth(s) / 2, 16777215, s, y);
                    }
                } else if (showCaptcha) {
                    drawColorBox(0xFFFFFF, (clientWidth - captcha.myWidth) / 2, 185, captcha.myWidth, captcha.myHeight + 10);
                    captcha.drawAdvancedSprite((clientWidth - captcha.myWidth) / 2, 190);

                    if (otherHover) {
                        newRegularFont.drawCenteredString("Back", 245, 205, 0xFFD700, 0);
                    } else {
                        newRegularFont.drawCenteredString("Back", 245, 205, 0xffffff, 0);
                    }
                }
            ...
            if (chatMessages[index] != null) {
                ...
                if ((type == 3 || type == 7) && (type == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(name))) {
                    ...
                    if (prefixName != null && prefixName.indexOf("@") == 0) {
                        ...
                        rights = Client.getClient().getPrefixRights(prefixName.substring(0, prefixName.indexOf(name)), substringLength == 6);
                    }
    ...
    private void loadingStages() {
        if (isLowDetail() && loadingStage == 2 && ObjectManager.currentPlane != plane) {
            gameScreenIP.initDrawingArea();
    ...
    public void markMinimap(Sprite sprite, int x, int y) {
        ...
        int spriteX = Rasterizer.SINE[rotation];
        int spriteY = Rasterizer.COSINE[rotation];
    ...
    private void processAnimableObjects() {
        ...
        for (; class30_sub2_sub4_sub3 != null; class30_sub2_sub4_sub3 = (Animable_Sub3) getIncompleteAnimables().reverseGetNext()) {
    ...
    private void readPlayerUpdateMask(int bitmap, int j, ByteBuffer buffer, Player player) {
        ...
        if ((bitmap & 8) != 0) {
            ...
            } else if (l == -1 || player.anim == -1 || Animation.cache[l].forcedPriority >= Animation.cache[player.anim].forcedPriority) {
                player.anim = l;
                player.currentAnimFrame = 0;
                player.anInt1528 = 0;
                player.animationDelay = i2;
                ...
                if (!flag && anInt1251 == 0) {
                    try {
                        ...
                        if (Configuration.HIGHLIGHT_USERNAME) {
                            pushMessage(s.replace(myPlayer.name.toLowerCase(), "<col=ff0000>" + myPlayer.name.toLowerCase() + "</col>").replace(myPlayer.name, "<col=ff0000>" + myPlayer.name + "</col>"), 2, prefix + player.name, player.loyaltyTitle, player.loyaltyColor, player.loyaltyPosition, chatRights);
                        } else {
                            pushMessage(s, 2, prefix + player.name, player.loyaltyTitle, player.loyaltyColor, player.loyaltyPosition, chatRights);
                        }
                    } catch (Exception exception) {
    ...
    private void method130(int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2) {
        ...
        if (class30_sub1 == null) {
            ...
            getaClass19_1179().pushHead(class30_sub1);
        }
    ...
    private void parseEntityPacket(ByteBuffer stream, int j) {
        ...
        if (j == 215) {
            ...
            if (k6 >= 0 && j9 >= 0 && k6 < 104 && j9 < 104 && i12 != playerId) {
                ...
                groundArray[plane][k6][j9].pushHead(class30_sub2_sub4_sub2_2);
        ...
        if (j == 160) {
            ...
            if (j4 >= 0 && i7 >= 0 && j4 < 103 && i7 < 103) {
                ...
                if (objectType == 2) {
                    ...
                    if (class28 != null) {
                        class28.aClass30_Sub2_Sub4_521 = new RenderableObject(class28.uid >> 14 & 0x7fff, k14, j12, i19, l19, j18, k20, j17, false);
                    }
                }
        ...
        if (j == 4) {
            ...
            if (i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104) {
                ...
                getIncompleteAnimables().pushHead(class30_sub2_sub4_sub3);
            }
        ...
        if (j == 44) {
            ...
            if (l10 >= 0 && i13 >= 0 && l10 < 104 && i13 < 104) {
                ...
                groundArray[plane][l10][i13].pushHead(class30_sub2_sub4_sub2_1);
        ...
        if (j == 117) {
            ...
            if (l5 >= 0 && k8 >= 0 && l5 < 104 && k8 < 104 && j11 >= 0 && k13 >= 0 && j11 < 104 && k13 < 104 && i17 != 65535) {
                ...
                getProjectiles().pushHead(class30_sub2_sub4_sub4);
            }
        }
    }
  ...
  /*  private void renderParticles() {
        ...
        while (it.hasNext()) {
            ...
            if (p != null) {
                ...
                if (p.isDead()) {
                    ...
                    DrawingArea.fillCircle(projection[0], projection[1], projection[2], (int) (size * 4), p.getColor(), alpha);
                }
            }
        }
    ...
    private int[] particleProjection(int i, int j, int l) {
        ...
        l = i1 * j1 + l * k1 >> 16;
        if (l >= 50) {
            return new int[]{Rasterizer.centerX + (i << viewDistance) / l, Rasterizer.centerY + (j2 << viewDistance) / l, l, Rasterizer.centerX + (i / 2 << viewDistance) / l, Rasterizer.centerY + (j2 / 2 << viewDistance) / l, Rasterizer.centerX + (i / 2 << viewDistance) / l, Rasterizer.centerY + (j2 / 2 << viewDistance) / l};
        } else {
            return new int[]{-1, -1, -1, -1, -1, -1, -1};
        }
    }*/
        ...
        if (loggedIn) {
            ...
            if (!oriented) {
                ...
                if (Configuration.TOGGLE_FOV) {
                    viewDistance = getScreenWidth() >= 1024 ? 10 : 9;
                } else {
                    viewDistance = 9;
                }
        ...
        try {
            ...
            if (!requestMapReconstruct) {
                for (int i3 = 0; i3 < k2; i3++) {
                    ...
                    if (abyte0 != null) {
                        objectManager.method180(abyte0, k5, i4, (currentRegionX - 6) * 8, (currentRegionY - 6) * 8, collisionData);
                    }
                }
                ...
                for (int i6 = 0; i6 < k2; i6++) {
                    ...
                    if (abyte1 != null) {
                        ...
                        objectManager.method190(l8, collisionData, k9, scene, abyte1);
                    }
                }
                        ...
                        for (int y = 0; y < 13; y++) {
                            ...
                            if (chunkBits != -1) {
                                ...
                                for (int l11 = 0; l11 < mapCoordinates.length; l11++) {
                                    ...
                                    objectManager.method179(z, rotation, collisionData, x * 8, (xCoord & 7) * 8, terrainData[l11], (yCoord & 7) * 8, plane, y * 8);
                                    break;
                                }
                            }
                        }
                        ...
                        for (int chunkY = 0; chunkY < 13; chunkY++) {
                            ...
                            if (tileBits != -1) {
                                ...
                                for (int idx = 0; idx < mapCoordinates.length; idx++) {
                                    ...
                                    objectManager.readObjectMap(collisionData, scene, plane, chunkX * 8, (coordY & 7) * 8, chunkZ, objectData[idx], (coordX & 7) * 8, rotation, chunkY * 8);
                                    break;
                                }
                            }
                        }
    ...
    private void processProjectiles() {
        for (PlayerProjectile class30_sub2_sub4_sub4 = (PlayerProjectile) getProjectiles().reverseGetFirst(); class30_sub2_sub4_sub4 != null; class30_sub2_sub4_sub4 = (PlayerProjectile) getProjectiles().reverseGetNext()) {
        ...
        do {
           ...
           /* if (backDialogID == 310 || backDialogID == 306 || backDialogID == 315 || backDialogID == 321
            ...
            if (consoleOpen) {
                ...
                if (key >= 32 && key <= 122 && amountOrNameInput.length() < 24) {
                    amountOrNameInput += (char) key;
                    inputTaken = true;
                }
    ...
    private void readNPCUpdateMask(ByteBuffer stream) {
        for (int j = 0; j < playersToUpdateCount; j++) {
            ...
            if ((l & 0x10) != 0) {
                ...
                } else if (i1 == -1 || npc.anim == -1 || Animation.cache[i1].forcedPriority >= Animation.cache[npc.anim].forcedPriority) {
                    npc.anim = i1;
                    npc.currentAnimFrame = 0;
                    npc.anInt1528 = 0;
                    npc.animationDelay = i2;
    ...
    private void method89(Class30_Sub1 class30_sub1) {
        ...
        if (i != 0) {
            int i1 = scene.fetchObjectIDTagForPosition(class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298, i);
            j = i >> 14 & 0x7fff;
            k = i1 & 0x1f;
            l = i1 >> 6;
        }
        ...
        try {
            ...
            switch (pktType) {
                ...
                case 35:
                    ...
                    cameraAntibanCurveYOffsets[l3] = j17;
                ...
                case 253:
                    ...
                    if (s.startsWith("casketopening##")) {
                        ...
                        if (boxargs[1] != null) {
                            casketOpening.handledPacket34(Integer.parseInt(boxargs[1]), Integer.parseInt(boxargs[2]) + 1, Integer.parseInt(boxargs[3]), Integer.parseInt(boxargs[4]));
                        }
                        pktType = -1;
                        return true;
                    }
            ...
            Signlink.reportError("Packet not handled: type " + pktType + ", size " + pktSize + " - currentPacket " + previousPacket + ", lastPacket " + anInt843);
            // resetLogout();
        } catch (IOException _ex) {
            dropClient();
        } catch (Exception exception) {
            String s2 = "Packet received but exception occurred: type " + pktType + ", currentPacket " + previousPacket + ", lastPacket " + anInt843 + ", size " + pktSize + ", pos " + (regionBaseX + myPlayer.smallX[0]) + "," + (regionBaseY + myPlayer.smallY[0]) + ", buffer - ";
            ...
            for (int i = 0; i < accountHovers.length; i++) {
                if (accountHovers[i] || accountDeletion[i]) {
                    ...
                    if (accountDeletion[i]) {
                        ...
                        // login(myPassword, false, myUsername, this);
    ...
    public void pushMessage(String chatMessage, int chatType, String chatName, String title, int color, int position, List<Integer> rights) {
    ...
    public void resetImageProducers2() {
        ...
        gameScreenIP = new RSImageProducer(512, 334, getGameComponent());//GameFrame.getScreenMode() == ScreenMode.FIXED && isGameFrameVisible() ? 512 : getScreenWidth(), GameFrame.getScreenMode() == ScreenMode.FIXED && isGameFrameVisible() ? 334 : getScreenHeight(), getGameComponent());
        DrawingArea.setAllPixelsToZero();
    ...
    public void resetLogout() {
        ...
        if (Configuration.SAVE_ACCOUNTS) {
            ...
            if (!updated) {
                accountManager.addAccount(new Account(myUsername, password, myPlayer.myGender, myPlayer.equipment[0] >= 1164 ? myPlayer.equipment[0] - 512 : 0, myPlayer.equipment[0] < 1164 ? myAppearance[0] == 0 ? myHeadAndJaw[0] : myAppearance[0] : 0, myAppearance[1] == 0 ? myHeadAndJaw[1] : myAppearance[1]), false);
            } else {
                accountManager.updateInterface();
            }
    ...
    private void spawnGroundItem(int i, int j) {
        ...
        scene.method281(i, i1, (Animable) obj1, method42(plane, j * 128 + 64, i * 128 + 64), (Animable) obj2, (Animable) obj, plane, j);
    }
    ...
    void startUp() {
       ...
       // RICH_PRESENCE.initiate();
        ...
        if (!new File(Signlink.getCacheDirectory() + "Shop/stock.png").exists()) {
            HttpDownloadUtility.downloadFile("http://atlantis317.com/server/stock.png", Signlink.getCacheDirectory() + "Shop/");
        }
        ...
        try {
            ...
            try {
               ...
               /* for (int j6 = 9; j6 < 18; j6++) {
                	headIcons[j6] = new Sprite(mediaArchive, "headicons_prayer", j6);
                    //headIcons[j6] = Client.spritesMap.get(j6 + 357 - 9);
                }*/
            ...
            FloorDefinitions.unpackUnderlays(streamLoader);
            FloorDefinitions.unpackOverlays(streamLoader);
    ...
    private void unlickCaches() {
        ...
        FrameReader.mapRS2.clear();
        ObjectDefinition.map.clear();
        ItemDefinition.map.clear();
        MobDefinition.map.clear();
        spritesMap.clear();
    }
                    ...
                    try {
                        ...
                        if (spriteDrawX > -1) {
                            if (Configuration.NEW_HEALTH_BARS) {
                                double hpWidth;
                                int cur = ((Entity) (obj)).currentHealth;
                                int max = ((Entity) (obj)).maxHealth;
                                if (cur > 0) {
                                ...
                                if (maxHealth >= 2000) {
                                    spritesMap.get(349).drawSprite(spriteDrawX - 44, spriteDrawY - 5);
                                    Sprite HPBarFull = new Sprite(spritesMap.getData(397), (int) Math.min(hpWidth, 56), 7, 1);
                                    HPBarFull.drawSprite(spriteDrawX - 44, spriteDrawY - 5);
                                    HPBarFull = null;
                                } else {
                                    spritesMap.get(349).drawSprite(spriteDrawX - 28, spriteDrawY - 5);
                                    Sprite HPBarFull = new Sprite(spritesMap.getData(348), (int) Math.min(hpWidth, 56), 7, 1);
                                ...
                                DrawingArea.drawPixels(5, spriteDrawY - 3, spriteDrawX - 12, 65280, i1);
                                DrawingArea.drawPixels(5, spriteDrawY - 3, spriteDrawX - 12 + i1, 0xff0000, 30 - i1);
                            }
                ...
                for (int j1 = 0; j1 < 4; j1++) {
                    if (((Entity) obj).hitsLoopCycle[j1] > loopCycle) {
                        ...
                        if (!Configuration.NEW_HITMARKS) {
                            ...
                            hitmarkDrawNew(entity, String.valueOf(entity.hitArray[j1]).length(), entity.hitMarkTypes[j1], entity.hitIcon[j1], entity.hitArray[j1], entity.soakDamage[j1], entity.hitmarkMove[j1], entity.hitmarkTrans[j1], j1);
                        }
            ...
            for (int k = 0; k < anInt974; k++) {
                ...
                if (anInt1249 == 0) {
                    ...
                    if (anIntArray981[k] == 1) {
                        chatTextDrawingArea.method386(0, s, spriteDrawX + 1, renderCycle, spriteDrawY + 1);
                        chatTextDrawingArea.method386(i3, s, spriteDrawX, renderCycle, spriteDrawY);
                    }

                    if (anIntArray981[k] == 2) {
                        chatTextDrawingArea.method387(spriteDrawX + 1, s, renderCycle, spriteDrawY + 1, 0);
                        chatTextDrawingArea.method387(spriteDrawX, s, renderCycle, spriteDrawY, i3);
                    }

                    if (anIntArray981[k] == 3) {
                        chatTextDrawingArea.method388(150 - anIntArray982[k], s, renderCycle, spriteDrawY + 1, spriteDrawX + 1, 0);
                        chatTextDrawingArea.method388(150 - anIntArray982[k], s, renderCycle, spriteDrawY, spriteDrawX, i3);
                    }
    ...
    private int calculateHitpointsColor(int percentage) {
        int[] colorArray = new int[]{0x01DF01, 0x3ADF00, 0x74DF00, 0xA5DF00, 0xD7DF01, 0xDBA901, 0xDF7401, 0xDF3A01, 0xFA5858, 0xFE2E2E, 0xDF0101,};
    ...
    public void updateGameArea() {
        try {
            ...
            Rasterizer.setBounds(GameFrame.getScreenMode() == ScreenMode.FIXED && isGameFrameVisible() ? chatAreaIP != null ? chatAreaIP.width : 519 : getScreenWidth(), GameFrame.getScreenMode() == ScreenMode.FIXED && isGameFrameVisible() ? chatAreaIP != null ? chatAreaIP.height : 165 : getScreenHeight());
            anIntArray1180 = Rasterizer.lineOffsets;
            Rasterizer.setBounds(GameFrame.getScreenMode() == ScreenMode.FIXED && isGameFrameVisible() ? tabAreaIP != null ? tabAreaIP.width : 346 : getScreenWidth(), GameFrame.getScreenMode() == ScreenMode.FIXED && isGameFrameVisible() ? tabAreaIP != null ? tabAreaIP.height : 335 : getScreenHeight());
            ...
            SceneGraph.method310(500, 800, !loggedIn ? getScreenWidth() : gameAreaWidth, !loggedIn ? getScreenHeight() : gameAreaHeight, ai);
    ...
    public void drawCombatBox(int xPos, int yPos, int width, int height, int currentHp, int maxHp, int hpBarXPps) {
        ...
        if (maxHp > 0) {
            newBoldFont.drawCenteredString((int) percentOfHpLeft + "%/" + 100 + "%", xPos + (width / 2), hpBarYPos + 13, 16777215, 0);
        } else {
