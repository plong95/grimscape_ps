...
public class DidYouKnowTask extends Task {
    ...
    public void execute() {
        ...
        messages.set(0, "<img=505>[<=col=FF0000>DYK?</col>]: <col="+Color.PURPLE.getColorValue()+">" + messages.get(0) + (messages.size() > 1 ? "..." : "")); //Maroon and Purple are the best colours for this type of message
