...
public enum Collection {
    ...
    ANCIENT_CHAOS_ELEMENTAL(AttributeKey.ANCIENT_CHAOS_ELEMENTALS_KILLED, LogType.BOSSES, "Ancient Chaos Elemental", new int[] {CustomNpcIdentifiers.ANCIENT_CHAOS_ELEMENTAL}, AttributeKey.ANCIENT_CHAOS_ELEMENTAL_LOG_CLAIMED, new Item[] { new Item(KEY_OF_DROPS) },
        //Drops
        new Item(CustomItemIdentifiers.ANCIENT_CHAOS_ELEMENTAL_PET), new Item(OCCULT_NECKLACE_OR), new Item(ETERNAL_BOOTS), new Item(BLOOD_MONEY_CASKET), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX)
    ),
    ...
    ANCIENT_BARRELCHEST(AttributeKey.ANCIENT_BARRELCHESTS_KILLED, LogType.BOSSES, "Ancient Barrelchest", new int[] {CustomNpcIdentifiers.ANCIENT_BARRELCHEST}, AttributeKey.ANCIENT_BARRELCHEST_LOG_CLAIMED, new Item[] { new Item(ANCIENT_WARRIOR_CLAMP) },
        //Drops
        new Item(CustomItemIdentifiers.ANCIENT_BARRELCHEST_PET), new Item(AMULET_OF_FURY_OR), new Item(PRIMORDIAL_BOOTS), new Item(BLOOD_MONEY_CASKET), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX), new Item(ANCIENT_WARRIOR_CLAMP)
    ),
    ...
    ANCIENT_KING_BLACK_DRAGON(AttributeKey.ANCIENT_KING_BLACK_DRAGONS_KILLED, LogType.BOSSES, "Ancient King Black Dragon", new int[] {CustomNpcIdentifiers.ANCIENT_KING_BLACK_DRAGON}, AttributeKey.ANCIENT_KING_BLACK_DRAGON_LOG_CLAIMED, new Item[] { new Item(KEY_OF_DROPS) },
        //Drops
        new Item(CustomItemIdentifiers.ANCIENT_KING_BLACK_DRAGON_PET), new Item(NECKLACE_OF_ANGUISH), new Item(DRAGONFIRE_WARD), new Item(DRAGONFIRE_SHIELD), new Item(ANCIENT_WYVERN_SHIELD), new Item(PEGASIAN_BOOTS), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX), new Item(ARMADYL_GODSWORD_OR), new Item(DRAGON_CLAWS_OR), new Item(ANCIENT_FACEGAURD)
    ),
    ...
    KERBEROS(AttributeKey.KERBEROS_KILLED, LogType.BOSSES, "Kerberos", new int[] {CustomNpcIdentifiers.KERBEROS}, AttributeKey.KERBEROS_LOG_CLAIMED, new Item[] { new Item(SAELDOR_SHARD,100) },
        //Drops
        new Item(CustomItemIdentifiers.KERBEROS_PET), new Item(BLOOD_MONEY_CASKET), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(PEGASIAN_BOOTS), new Item(ETERNAL_BOOTS), new Item(PRIMORDIAL_BOOTS), new Item(LARRANS_KEY_TIER_III), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(ABYSSAL_BLUDGEON), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(VAMPYRE_DUST), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX), new Item(PEGASIAN_BOOTS_OR), new Item(ETERNAL_BOOTS_OR), new Item(PRIMORDIAL_BOOTS_OR), new Item(PHARAOHS_HILT)
    ),
    ...
    SKORPIOS(AttributeKey.SKORPIOS_KILLED, LogType.BOSSES, "Skorpios", new int[] {CustomNpcIdentifiers.SKORPIOS}, AttributeKey.SKORPIOS_LOG_CLAIMED, new Item[] { new Item(SAELDOR_SHARD,100) },
        //Drops
        new Item(CustomItemIdentifiers.SKORPIOS_PET), new Item(BLOOD_MONEY_CASKET), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX), new Item(LARRANS_KEY_TIER_III), new Item(ANTIQUE_EMBLEM_TIER_10), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(DARK_ARMADYL_HELMET), new Item(BOW_OF_FAERDHINEN_3)
    ),
    ...
    ARACHNE(AttributeKey.ARACHNE_KILLED, LogType.BOSSES, "Arachne", new int[] {CustomNpcIdentifiers.ARACHNE}, AttributeKey.ARACHNE_LOG_CLAIMED, new Item[] { new Item(SAELDOR_SHARD,100) },
        //Drops
        new Item(CustomItemIdentifiers.ARACHNE_PET), new Item(BLOOD_MONEY_CASKET), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX), new Item(LARRANS_KEY_TIER_III), new Item(ANTIQUE_EMBLEM_TIER_10), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(DARK_ARMADYL_CHAINSKIRT), new Item(BOW_OF_FAERDHINEN_3)
    ),
    ...
    ARTIO(AttributeKey.ARTIO_KILLED, LogType.BOSSES, "Artio", new int[] {CustomNpcIdentifiers.ARTIO}, AttributeKey.ARTIO_LOG_CLAIMED, new Item[] { new Item(SAELDOR_SHARD,100) },
        //Drops
        new Item(CustomItemIdentifiers.ARTIO_PET), new Item(BLOOD_MONEY_CASKET), new Item(CustomItemIdentifiers.WEAPON_MYSTERY_BOX), new Item(CustomItemIdentifiers.ARMOUR_MYSTERY_BOX), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX), new Item(KEY_OF_DROPS), new Item(EPIC_PET_BOX), new Item(LARRANS_KEY_TIER_III), new Item(ANTIQUE_EMBLEM_TIER_10), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SAELDOR_SHARD), new Item(DARK_ARMADYL_CHESTPLATE), new Item(BOW_OF_FAERDHINEN_3)
    ),
    ...
    MYSTERY_CHEST(AttributeKey.MYSTERY_CHESTS_OPENED, LogType.MYSTERY_BOX, "Mystery chest", new int[] {CustomItemIdentifiers.MYSTERY_CHEST}, AttributeKey.MYSTERY_CHEST_LOG_CLAIMED, new Item[] { new Item(CustomItemIdentifiers.MYSTERY_CHEST,2) },
        new Item(SANGUINE_SCYTHE_OF_VITUR), new Item(SANGUINE_TWISTED_BOW), new Item(TWISTED_BOW_I), new Item(HOLY_SCYTHE_OF_VITUR), new Item(ELYSIAN_SPIRIT_SHIELD), new Item(TWISTED_BOW), new Item(SCYTHE_OF_VITUR), new Item(ANCIENT_WARRIOR_AXE_C), new Item(ANCIENT_WARRIOR_MAUL_C), new Item(ANCIENT_WARRIOR_SWORD_C),
    ...
    CHAMBER_OF_SECRETS(AttributeKey.CHAMBER_OF_SECRET_RUNS_COMPLETED, LogType.OTHER, "Chamber Of Secrets", new int[] {RAIDS_KEY}, AttributeKey.CHAMBER_OF_SECRETS_LOG_CLAIMED, new Item[] { new Item(CustomItemIdentifiers.RAIDS_MYSTERY_BOX,3) },
        //Custom
        new Item(FENRIR_GREYBACK_JR), new Item(FLUFFY_JR), new Item(CENTAUR_MALE), new Item(CENTAUR_FEMALE), new Item(DEMENTOR_PET), new Item(ELDER_WAND_HANDLE), new Item(ELDER_WAND_STICK), new Item(TALONHAWK_CROSSBOW), new Item(SWORD_OF_GRYFFINDOR), new Item(SALAZAR_SLYTHERINS_LOCKET),
        //Drops
        new Item(OLMLET), new Item(DEXTEROUS_PRAYER_SCROLL), new Item(ARCANE_PRAYER_SCROLL), new Item(TWISTED_BUCKLER), new Item(DRAGON_HUNTER_CROSSBOW), new Item(DINHS_BULWARK), new Item(ANCESTRAL_HAT), new Item(ANCESTRAL_ROBE_TOP), new Item(ANCESTRAL_ROBE_BOTTOM), new Item(DRAGON_CLAWS), new Item(ELDER_MAUL), new Item(KODAI_WAND), new Item(TWISTED_BOW),
        new Item(AVERNIC_DEFENDER), new Item(GHRAZI_RAPIER), new Item(SANGUINESTI_STAFF), new Item(JUSTICIAR_FACEGUARD), new Item(JUSTICIAR_LEGGUARDS), new Item(JUSTICIAR_CHESTGUARD), new Item(SCYTHE_OF_VITUR), new Item(CustomItemIdentifiers.LEGENDARY_MYSTERY_BOX), new Item(SCYTHE_OF_VITUR_KIT), new Item(TWISTED_BOW_KIT)),
    ;
